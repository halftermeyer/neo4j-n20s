...
| `n20s.graph.projectTemplate(name, template, row, [ifExists])` | Aggregating function: project nodes, relationships, paths, entity lists, or maps into a named graph via a JSON template (TDE/R2RML-style). Default ifExists: `'replace'` |
